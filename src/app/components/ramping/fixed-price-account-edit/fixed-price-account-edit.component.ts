...
@Component({
  selector: 'app-fixed-price-account-edit',
  templateUrl: './fixed-price-account-edit.component.html',
  styleUrls: ['./fixed-price-account-edit.component.scss']
})
export class FixedPriceAccountEditComponent implements OnInit{
  accountName: any;
  location: any;
  comments: any;
  userComments: any = [];
  ...
  constructor(
    public dialogRef: MatDialogRef<FixedPriceAccountEditComponent>,
  ...
  identifyLoginUser(dt) {
    ...
    this.IsUserApproved = dt[0].isApproved == undefined ? true : dt[0].isApproved;
  ...
  // getErrorCondition(){
  // var isValid =  this.commentInput.nativeElement.value == "" ? true :false;
  // return isValid;
  // }
